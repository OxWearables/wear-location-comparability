...
parser.add_argument('-l', '--logdir', type=str, required=True, metavar='path',
...
parser.add_argument('--conda-module', type=str, default='Miniforge3/24.1.2-0', metavar='name',
...
if not os.path.exists(args.logdir):
    print('Log directory does not exist:', args.logdir)
    sys.exit(-1)
